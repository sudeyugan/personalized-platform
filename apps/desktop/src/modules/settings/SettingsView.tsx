import { BookMarked, Check, Cloud, Database, ImageUp, LockKeyhole, Music2, Palette, Puzzle, ShieldCheck, Sparkles, Trash2 } from 'lucide-react'
...
export function SettingsView() {
  ...
  return (
    <main className="settings-view scroll-view">
      ...
      <SettingsCategory id="intelligence" title="AI 伙伴" description="模型、立绘、记忆与权限" icon={<Sparkles />}>
