...
const sections: HelpSection[] = [
  ...
  },
  {
    ...
    guides: [
      ...
      { title: '静态立绘与动态 WebM', body: '可以上传单张透明 PNG/WebP，或使用 9:16、VP9、静音且带透明通道的 WebM；960×1708 和 1792×3184 都可使用。动作库支持待机、倾听、回应、庆祝、关切、招呼、环顾、点头、害羞、困倦、伸懒腰和打哈欠；模型处理阶段使用环顾，缺少任何状态时回退待机。单击聊天、拖动移动、双击返回主窗口；默认 Ctrl+Alt+Y 显示或隐藏，Ctrl+Alt+T 可在安静穿透与原显示方式之间切换，两者都可在设置中更换或关闭。' },
