...
const sections: HelpSection[] = [
  ...
  },
  {
    ...
    guides: [
      ...
      { title: '语音、唤醒词与声纹', body: '配置 ElevenLabs 的语音识别、合成 Key 与 Voice ID 后，可以录音转写并流式朗读回答。语音唤醒默认关闭；首次启用需下载约 43 MB 本地模型，并可录入四段声音。待机时唤醒词与声纹都只在本机判断，通过后才连接 ElevenLabs，并进入约 45 秒可续期的简短语音聊天。唤醒词可自定义为二至六个汉字。' },
