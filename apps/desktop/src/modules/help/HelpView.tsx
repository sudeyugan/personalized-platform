...
const sections: HelpSection[] = [
  ...
  },
  {
    ...
    guides: [
      ...
      { title: '电脑能力与权限', body: '设置 → AI 伙伴 → 权限与记录 → 电脑能力中可开启。窗口、鼠标键盘、剪贴板、文件、程序、PowerShell、截图与录屏都通过统一 Tool 和双层权限检查；文件与程序可以按目录或目标长期授权，删除、关闭、移动、停止进程和 PowerShell 始终逐次确认。主开关默认关闭。' },
